""" Code Challenge - City Air Quality 

Code Challenge
  Name: Get Air Pollution by using city name
  Filename: cityairquality.py
    
  Problem Statement:
    Take the name of the city from the user through cmd and show the air quality 
    parameteres using openmapweather api. This API requires lat long of place to get 
    air quality.
